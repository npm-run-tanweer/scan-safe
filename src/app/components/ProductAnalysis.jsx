...
export default function ProductAnalysis({ scan }) {
  ...
  return (
    <div className="max-w-md mx-auto my-6 rounded-2xl shadow-lg overflow-hidden border border-slate-200 pb-10">
      {/* Header */}
      <div
        className={`p-4 flex flex-col items-center text-white ${
          scan.analysisResult?.status === "safe"
            ...
            ? "bg-gradient-to-r from-red-400/80 to-red-500/80 border-red-800"
